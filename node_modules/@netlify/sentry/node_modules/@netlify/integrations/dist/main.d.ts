...
export declare type IntegrationHandler<Context = any, Config = any> = (handler: FunctionHandler<Context>, config?: Config) => FunctionHandler<HandlerContext>;
...
export declare const wrap: <T extends IntegrationHandler<any, any>[]>(...handlers: T) => (functionHandler: (event: HandlerEvent, context: HandlerContext & ExtractContextTypes<T>) => Promise<HandlerResponse>, config?: ExtractConfigTypes<T> | undefined) => FunctionHandler<HandlerContext>;
export {};
